...
export const NAV_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    isActive: true,
    children: [
      { title: "Haftanin Firsatlari", href: "/products?campaign=weekly" },
      { title: "Yuzde 40'a Varan", href: "/products?campaign=flash" },
      { title: "Sepette Ek Indirim", href: "/products?campaign=cart" },
    ],
  },
  {
    id: "corporate",
    ...
    isActive: true,
    children: [
      { title: "Hakkimizda", href: "/corporate/hakkimizda" },
      { title: "KVKK", href: "/corporate/kvkk" },
      { title: "Iade Politikasi", href: "/corporate/iade-politikasi" },
...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 45999,
    category: "Elektronik",
    shortDescription: "14 inç, ince kasa, gunluk is ve oyun dengesi.",
    image: "/products/atlas-pro.jpg",
    isFeatured: true,
    isNew: true,
    isCampaign: false,
    has3d: true,
  },
  {
    ...
    price: 8699,
    category: "Elektronik",
    shortDescription: "Kablosuz baglanti ve surround destekli set.",
    image: "/products/nova-audio.jpg",
    isFeatured: true,
    isNew: false,
    isCampaign: true,
    has3d: false,
  },
  {
    ...
    price: 4299,
    category: "Ev",
    shortDescription: "Tek tus ile espresso ve filtre kahve hazirlar.",
    image: "/products/vera-coffee.jpg",
    isFeatured: false,
    isNew: true,
    isCampaign: true,
    has3d: true,
  },
  {
    ...
    price: 6399,
    category: "Yasam",
    shortDescription: "Bel destegi ve file sirtlik ile uzun calisma konforu.",
    image: "/products/modo-chair.jpg",
    isFeatured: true,
    isNew: false,
    isCampaign: false,
    has3d: true,
  },
  {
    ...
    price: 1999,
    category: "Ev",
    shortDescription: "Cam hazne, buz kirma modu ve kolay temizlik.",
    image: "/products/aero-blender.jpg",
    isFeatured: false,
    isNew: true,
    isCampaign: false,
    has3d: false,
  },
  {
    ...
    price: 17999,
    category: "Yasam",
    shortDescription: "Katlanabilir govde, sessiz motor, mobil uygulama destegi.",
