...
export function Sections({ title, description, children }: SectionsProps) {
  return (
    <section className="mt-8 rounded-[1.75rem] border border-[color:var(--color-border)] bg-[image:var(--gradient-surface-soft)] p-3.5 shadow-[0_18px_34px_var(--color-shadow-soft)] [content-visibility:auto] [contain-intrinsic-size:1px_780px] sm:mt-12 sm:p-6">
